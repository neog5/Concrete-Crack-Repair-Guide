...
public class PlasticShrinkage1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_plastic_shrinkage1);

        RecyclerView recyclerView = findViewById(R.id.rv22);
