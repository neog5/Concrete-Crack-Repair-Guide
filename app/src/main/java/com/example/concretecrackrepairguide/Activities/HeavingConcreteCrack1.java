...
public class HeavingConcreteCrack1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_heaving_concrete_crack1);

        RecyclerView recyclerView = findViewById(R.id.rv17);
