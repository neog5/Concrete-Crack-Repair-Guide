...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new CrackModel(R.drawable.corrosion_crack_column1, "Corrosion Crack Column 1"));
        ...
        list.add(new CrackModel(R.drawable.expansion_crack1, "Expansion Crack 1"));
        list.add(new CrackModel(R.drawable.expansion_crack2, "Expansion Crack 2"));
        ...
        list.add(new CrackModel(R.drawable.heaving_concrete_crack, "Heaving Concrete Crack"));
