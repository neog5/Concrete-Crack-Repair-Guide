...
public class EpoxyInjection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Expand("1. Clean the cracks", "• After the injected epoxy has cured, the surface seal should be removed by grinding or other means as appropriate.", R.drawable.expanding_background2));
